...
const messages = {};
languages.map(lang => {
    messages[lang] = Object.assign(__webpack_require__(177)(`./${lang}`), __webpack_require__(145)(`./${lang}`).default);
});
